# hangman_words.py 의 내용입니다. 그대로 복사하세요!
...
word_list = [
    ...
    'injury', 'ivory', 'ivy', 'jackpot', 'jaundice', 'jawbreaker', 'jaywalking',
    ...
    'kiwifruit', 'klutz', 'knapsack', 'larynx', 'luxury', 'marquis', 'matrix',
    'megahertz', 'microwave', 'mnemonic', 'mystify', 'naphtha', 'nightclub',
    'nowadays', 'numbskull', 'nymph', 'onyx', 'ovary', 'oxidize', 'oxygen',
    'pajamas', 'peekaboo', 'phlegm', 'pixel', 'pizazz', 'pneumonia', 'polka',
    ...
    'twelfths', 'unknown', 'unworthy', 'unzip', 'upgrowth', 'unwarranted',
    'vaporize', 'vixen', 'vodka', 'voodoo', 'vortex', 'voyeurism', 'walkway',
    'waltz', 'wave', 'wavy', 'waxy', 'wellspring', 'wheezy', 'whiskey',
    'whizzing', 'whomever', 'wimpy', 'witchcraft', 'wizard', 'woozy', 'wristwatch',
